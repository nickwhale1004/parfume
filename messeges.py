...
Заходите в меню и выбирайте что Вам интересно.""",
    ...
    "Choosed_last" : "Хорошо, Вам осталось только добавить комментарий или нажать 'не нужен', если Вам не нужен комментарий",
...
Пример: <i>88005555800</i>""",
    ...
    "Choose_comment": """<b>6. Укажите комментарий или нажмите "не нужен", если Вам не нужен комментарий:</b>
